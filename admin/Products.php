...
if (isset($_POST['save'])) {
    extract($_POST);
    $dir = "assets/admin/product/";
    $file = basename($_FILES['image']['name']);
    $file_type = strtolower(pathinfo($file, PATHINFO_EXTENSION));
    $target = $dir . uniqid("images_") . "." . $file_type;
    
    if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
        $q = "INSERT INTO product (product_name, product_image, product_price, product_desc, cat_id) VALUES ('$name', '$target', '$price', '$desc', '$category')";
        insert($q);
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <a class="nav-link btn btn-success create-new-button mb-5 mt-5" data-toggle="modal" data-target="#addModal" aria-expanded="false" href="#">+ Add New Product</a>
                      ...
                      <table class="table table-striped" >
                        ...
                        <tbody>
                          ...
                          <td><?php echo $row['cat_name'] ?></td>
                            ...
                            <td class="py-1 p-4">
                             <img style="border-radius: 0px; width: 100px; height: 100px;" src="<?php echo $row['product_image'] ?>" alt="image" />
                            </td>
                            ...
                            <td><button type="button"  class="btn btn-outline-danger"><a href="?did=<?php echo $row['product_id'] ?>" style="color: inherit;" onclick="return confirm('Are you sure you want to delete thi item?');"><i class="fa-solid fa-trash"></i>Delete</a></button></td>
                          </tr>
                          <?php
                          }
                          ?>
                       ...
                       <div class="modal-body">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                           <div class="form-group">
                              <select class="form-select form-control text-white" name="category" aria-label="Default select example">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" name="name" class="form-control text-white" id="field2" placeholder="Enter product name">
                           </div>
                           <div class="form-group">
                              <label for="field2">Product Price</label>
                              <input type="text" name="price" class="form-control text-white" id="field2" placeholder="Enter product price">
                           </div>
                           <div class="form-group">
                              <label for="exampleFormControlTextarea1">Product Description</label>
                              <textarea class="form-control text-white" name="desc" id="exampleFormControlTextarea1" rows="3" placeholder="Enter Product description"></textarea>
                           </div>
