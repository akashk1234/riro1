          ...
          <div class="content-wrapper">
              ...
              <div class="col-sm-4 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <a href="orders.html" style="color: white; text-decoration: none;">
                      <div class="row">
                        <div class="col-8 col-sm-12 col-xl-8 my-auto">
                          <div class="d-flex d-sm-block d-md-flex align-items-center">
              ...
              <div class="col-sm-4 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <a href="website.html" style="color: white; text-decoration: none;">
                      <div class="row">
                        <div class="col-8 col-sm-12 col-xl-8 my-auto">
                          <div class="d-flex d-sm-block d-md-flex align-items-center">
            ...
            <div class="row justify-content-center">
              <div class="col-xl-6 col-sm-6 grid-margin stretch-card">
                  <div class="card">
                      <div class="card-body">
                          <a href="shipped-orders.html" style="color: white; text-decoration: none;">
                            <div class="row">
                                <div class="col-9">
              ...
              <div class="col-xl-6 col-sm-6 grid-margin stretch-card">
                  <div class="card">
                      <div class="card-body">
                          <a href="delivered-orders.html" style="color: white; text-decoration: none;">
                            <div class="row">
                                <div class="col-9">
                                    <div class="d-flex align-items-center align-self-start">
